...
def admin_portal():
  ...
  <div class="admin-login" data-admin-login>
    <div>
      ...
      <p>This private portal gives B&M quick access to website status, edit requests, contact details, and Nebrex support without needing to touch code or hosting settings.</p>
    </div>
    <form class="portal-card" data-admin-form>
      <div class="brand portal-brand"><span class="brand-mark">B&M</span><span><strong>Auto Detailing</strong><small>Client portal</small></span></div>
      <label>Email<input type="email" data-admin-email autocomplete="email" placeholder="client@bmautodetailing.ca" required></label>
      ...
      <p class="portal-hint">Demo access for handoff: <strong>client@bmautodetailing.ca</strong> / <strong>BMAuto2026!</strong></p>
      <p class="portal-error" data-admin-error hidden>Use the portal email and password provided in the handoff.</p>
  ...
  <div class="admin-dashboard" data-admin-dashboard hidden>
    <div class="dashboard-hero">
      <div>
        ...
        <h1>B&M Auto Detailing admin portal.</h1>
        <p>Website ownership, service updates, quote requests, and support are organized here so the site stays clean and professional.</p>
      </div>
    ...
    <section class="portal-section">
      <div class="admin-list">
        ...
        <article><h3>Recommended workflow</h3><p>B&M sends updates by email or text. Nebrex applies them cleanly and keeps a backup of the site.</p></article>
      </div>
    </section>
  </div>
</section>"""
