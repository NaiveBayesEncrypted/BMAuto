...
def admin_portal():
  ...
  <div class="admin-login" data-admin-login>
    ...
    <form class="portal-card" data-admin-form>
      <div class="brand portal-brand"><span class="brand-mark">B&M</span><span><strong>Auto Detailing</strong><small>Admin access</small></span></div>
  ...
  <div class="admin-dashboard" data-admin-dashboard hidden>
    <div class="admin-layout">
      <aside class="admin-sidebar">
        <div class="brand portal-brand"><span class="brand-mark">B&M</span><span><strong>Admin</strong><small>Control panel</small></span></div>
      ...
      <div class="admin-main">
        ...
        <div class="metric-grid">
          ...
          <article class="metric-card"><span>Tracked pages</span><strong>20</strong><p>Customer pages in sitemap.</p></article>
          <article class="metric-card attention"><span>Visits</span><strong>Connect</strong><p>Cloudflare Analytics can unlock live visitor counts.</p></article>
        </div>
        <section class="portal-section" id="analytics">
          ...
          <div class="analytics-panel">
            <div class="chart-card">
              <div class="chart-head"><span>Visits preview</span><strong>Awaiting analytics connection</strong></div>
              <div class="bar-chart" aria-label="Analytics preview bars"><span style="height:38%"></span><span style="height:62%"></span><span style="height:48%"></span><span style="height:74%"></span><span style="height:56%"></span><span style="height:82%"></span><span style="height:68%"></span></div>
            </div>
            <div class="admin-list compact">
              <article><h3>Top pages</h3><p>Home, Services, Packages, Contact, and Admin are ready to track after analytics setup.</p></article>
              <article><h3>Lead actions</h3><p>Get Quote, Call Now, Google Maps, and Request Website Edit buttons are ready for click tracking.</p></article>
            </div>
          </div>
        </section>
