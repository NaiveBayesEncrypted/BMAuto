  ...
  <div class="admin-dashboard" data-admin-dashboard hidden>
    <div class="dashboard-hero">
      <div>
        ...
        <p>Website ownership, service updates, quote requests, and support are organized here so the public site stays clean, current, and professional.</p>
      </div>
    ...
    <section class="portal-section">
      <div class="admin-list">
        ...
        <article><h3>Recommended workflow</h3><p>B&M sends updates through the portal actions. Nebrex applies them cleanly and keeps a backup of the site.</p></article>
      </div>
    </section>
  </div>
</section>"""
