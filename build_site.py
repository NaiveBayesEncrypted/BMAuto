...
<body class="page-{active.replace('.html','') or 'home'}">
  ...
  <header class="site-header" data-header>
    ...
    <a class="brand" href="/" aria-label="B&M Auto Detailing home">
      <img class="brand-logo" src="{img['logo_header']}" alt="B&M Auto Detailing" width="760" height="170">
    </a>
...
.site-header .brand{min-width:0;flex:0 1 auto}.site-header .brand-logo{width:clamp(10.5rem,17vw,19rem);max-width:100%}.footer-brand{display:block;min-width:0;width:auto}.portal-brand{min-width:0}.brand-logo.footer-logo{width:min(21rem,100%)}@media (max-width:680px){.site-header .brand-logo{width:9.4rem}.footer-logo{width:18rem}.portal-logo{width:100%}.admin-logo{width:3rem}}
"""
