...
img = {
    "hero": "https://commons.wikimedia.org/wiki/Special:FilePath/Mobile_Wash_partner_washing_a_car.jpg?width=1800",
    "studio": "https://commons.wikimedia.org/wiki/Special:FilePath/Detailerzy_przy_Mustangu.jpg?width=1600",
    "detail": "https://commons.wikimedia.org/wiki/Special:FilePath/Car_washer_at_work.jpg?width=1400",
    "coating": "https://commons.wikimedia.org/wiki/Special:FilePath/Folia-ppf.jpg?width=1400",
    "ppf": "https://commons.wikimedia.org/wiki/Special:FilePath/Caterham_Roadsport_building_-_145_-_Fitting_paint_protection_film%2C_LHS_-_Flickr_-_exfordy.jpg?width=1400",
    "correction": "https://commons.wikimedia.org/wiki/Special:FilePath/Lucidatura_Veicolo_Auto_Detailing.jpg?width=1400",
    "interior": "https://commons.wikimedia.org/wiki/Special:FilePath/Cleaning_interior.jpg?width=1400",
}
...
def service_cards():
  ...
  <div class="service-card-body"><h3>{title}</h3><p>{desc}</p><ul>{''.join(f'<li>{b}</li>' for b in bullets)}</ul><a class="service-link" href="{href}">Learn more</a></div>
...
def review_cards(limit=None):
  ...
  <div class="review-top"><strong>{review['name']}</strong><span>{review['rating']}.0 / 5</span></div>
...
<section class="hero home-hero">
  <img src="{img['hero']}" alt="Premium automotive detailing studio finish on a dark vehicle">
  ...
  <div class="hero-content">
    ...
    <p>Professional interior detailing, exterior care, paint correction, ceramic coating, and PPF for Calgary drivers who want their vehicle cleaner, glossier, and better protected year-round.</p>
...
<section class="section"><div class="section-head"><p class="eyebrow">Services</p><h2>Detailing and protection services for Calgary vehicles.</h2><p>Choose the service that matches the condition of the vehicle today and the protection it needs for Alberta driving.</p></div><div class="service-grid">{service_cards()}</div></section>
...
<section class="section dark-band"><div class="section-head stacked"><p class="eyebrow">Work examples</p><h2>Service visuals that match what customers are booking.</h2></div><div class="before-grid">
  ...
  <article class="before-card"><img class="proof-image" src="{img['ppf']}" alt="Paint protection film installation example" loading="lazy"><h3>Front-end protection</h3><p>PPF planning and installation for rock-chip-prone Calgary driving.</p></article>
</div></section>
<section class="section"><div class="section-head"><p class="eyebrow">Packages</p><h2>Packages and pricing guide.</h2><p>Compare common starting points before requesting a quote. Final pricing depends on vehicle size, condition, correction needs, and protection goals.</p></div><div class="package-grid">{package_cards(5)}</div></section>
...
<section class="section"><div class="section-head"><p class="eyebrow">Customer reviews</p><h2>Trusted by Calgary drivers who care about results.</h2><p>Customers mention clean interiors, strong exterior results, fair pricing, professional communication, PPF installation, and vehicles looking better than expected.</p></div><div class="review-grid">{review_cards(3)}</div><a class="text-link" href="reviews.html">Read customer reviews</a></section>
...
<section class="subhero">
  ...
  <img src="{image_url}" alt="{h1} professional result" loading="eager">
</section>
{trust_bar()}
...
pages = {
    ...
    "image-credits.html": simple_page("image-credits.html", "Image Credits | B&M Auto Detailing", "Reusable image credits and license details for B&M Auto Detailing website photography.", """<section class="subhero text-only"><div><p class="eyebrow">Image credits</p><h1>Reusable photography sources.</h1><p>The website uses reusable Wikimedia Commons images where B&M shop-owned photography is not yet available. These should be replaced with real B&M project photos as soon as possible.</p></div></section><section class="section"><div class="feature-grid"><article><h3>Auto detailing wash</h3><p>Mobile Wash partner washing a car by Juanacosta84, CC BY-SA 4.0, Wikimedia Commons.</p></article><article><h3>Interior cleaning</h3><p>Cleaning interior by Juanacosta84, CC BY-SA 4.0, Wikimedia Commons.</p></article><article><h3>Detailing studio work</h3><p>Detailerzy przy Mustangu by Caroseria, CC BY-SA 4.0, Wikimedia Commons.</p></article><article><h3>Paint correction</h3><p>Lucidatura Veicolo Auto Detailing by Harrycapta, CC BY-SA 4.0, Wikimedia Commons.</p></article><article><h3>Paint protection film</h3><p>Fitting paint protection film by Brian Snelson, CC BY 2.0, Wikimedia Commons.</p></article><article><h3>PPF material</h3><p>Folia-ppf by Kuba Jakubowicz, CC BY-SA 4.0, Wikimedia Commons.</p></article></div></section>"""),
}
