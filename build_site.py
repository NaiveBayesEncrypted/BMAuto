...
.site-header .brand{min-width:0;flex:0 0 auto}.brand-wordmark{display:flex;align-items:center;gap:.82rem}.brand-wordmark strong{font-size:1.28rem;line-height:1;letter-spacing:.01em;font-weight:800;color:var(--text);padding:.48rem .58rem;border:1px solid rgba(185,149,98,.48);background:#0b0e10}.brand-wordmark span{display:grid;gap:.22rem}.brand-wordmark b{display:block;font-size:.78rem;line-height:1;letter-spacing:.08em;text-transform:uppercase;color:var(--text);font-weight:800;white-space:nowrap}.brand-wordmark small{display:block;font-size:.58rem;line-height:1;letter-spacing:.08em;text-transform:uppercase;color:var(--muted);white-space:nowrap}.site-header .brand-logo{width:clamp(10.5rem,17vw,19rem);max-width:100%}.footer-brand{display:block;min-width:0;width:auto}.portal-brand{min-width:0}.brand-logo.footer-logo{width:min(21rem,100%)}@media (max-width:680px){.brand-wordmark{gap:.5rem}.brand-wordmark strong{font-size:1rem;padding:.42rem .46rem}.brand-wordmark b{font-size:.62rem;letter-spacing:.06em}.brand-wordmark small{display:none}.footer-logo{width:18rem}.portal-logo{width:100%}.admin-logo{width:3rem}}
"""
