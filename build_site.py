...
<body class="page-{active.replace('.html','') or 'home'}">
  ...
  <header class="site-header" data-header>
    ...
    <a class="brand" href="/" aria-label="B&M Auto Detailing home">
      <span class="brand-wordmark"><strong>B&M</strong><i></i><span><b>Auto Detailing</b><small>Calgary vehicle protection</small></span></span>
    </a>
...
.site-header .brand{min-width:0;flex:0 0 auto}.brand-wordmark{display:grid;grid-template-columns:auto auto auto;align-items:center;gap:.62rem}.brand-wordmark strong{font-size:1.62rem;line-height:.9;letter-spacing:.01em;font-weight:850;color:var(--text)}.brand-wordmark i{display:block;width:2.6rem;height:2px;background:var(--accent);align-self:end;margin-bottom:.2rem}.brand-wordmark b{display:block;font-size:.72rem;line-height:1;letter-spacing:.14em;text-transform:uppercase;color:var(--text);font-weight:850;white-space:nowrap}.brand-wordmark small{display:block;margin-top:.24rem;font-size:.5rem;line-height:1;letter-spacing:.13em;text-transform:uppercase;color:var(--muted);white-space:nowrap}.site-header .brand-logo{width:clamp(10.5rem,17vw,19rem);max-width:100%}.footer-brand{display:block;min-width:0;width:auto}.portal-brand{min-width:0}.brand-logo.footer-logo{width:min(21rem,100%)}@media (max-width:680px){.brand-wordmark{gap:.45rem}.brand-wordmark strong{font-size:1.38rem}.brand-wordmark i{width:1.55rem}.brand-wordmark b{font-size:.56rem;letter-spacing:.1em}.brand-wordmark small{display:none}.footer-logo{width:18rem}.portal-logo{width:100%}.admin-logo{width:3rem}}
"""
